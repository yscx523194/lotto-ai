export function IconClover({ size = 24, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 4.5C12 2.5 10 1 8 1S4 2.5 4 4.5C4 7 7 9 12 12C17 9 20 7 20 4.5C20 2.5 18 1 16 1S12 2.5 12 4.5Z" />
      <path d="M12 19.5C12 21.5 10 23 8 23S4 21.5 4 19.5C4 17 7 15 12 12C17 15 20 17 20 19.5C20 21.5 18 23 16 23S12 21.5 12 19.5Z" />
      <path d="M4.5 12C2.5 12 1 10 1 8S2.5 4 4.5 4C7 4 9 7 12 12C9 17 7 20 4.5 20C2.5 20 1 18 1 16S2.5 12 4.5 12Z" />
      <path d="M19.5 12C21.5 12 23 10 23 8S21.5 4 19.5 4C17 4 15 7 12 12C15 17 17 20 19.5 20C21.5 20 23 18 23 16S21.5 12 19.5 12Z" />
    </svg>
  );
}

export function IconRefresh({ size = 20, color = 'currentColor', className = '' }) {
  return (
...
export function Spinner({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={{ animation: 'spin 1s linear infinite' }}>
      <circle cx="12" cy="12" r="10" stroke="var(--text-muted)" strokeWidth="3" opacity="0.3" />
